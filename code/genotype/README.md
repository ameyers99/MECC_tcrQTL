...
- Outputs an LD matrix and PLINK1 binary files for (a) 2-field alleles (field-separated names; e.g., HLA_A_02_01, HLA_DRB1_03_01) and (b) amino acid polymorphisms, called using IMGT reference data `./data/genotype/HLA_DICTIONARY_AA.hg19.imgt3320.AA_tf.in_ref.rds`;
