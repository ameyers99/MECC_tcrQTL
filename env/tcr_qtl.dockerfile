...
# ---- Install GCTA 1.95.2 ----
RUN wget https://yanglab.westlake.edu.cn/software/gcta/bin/gcta-1.95.2-linux-x86_64.zip && \
    unzip gcta-1.95.2-linux-x86_64.zip && \
    mv ./gcta-1.95.2-linux-x86_64/gcta /usr/local/bin && chmod +x /usr/local/bin/gcta && \
    rm -rf gcta-1.95.2-linux-x86_64 __MACOSX gcta-1.95.2-linux-x86_64.zip
